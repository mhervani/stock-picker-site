...
def main():
    if len(sys.argv) != 2:
        print("Bruk: python3 scripts/run_midmonth_flow.py 2026-05")
        sys.exit(1)
    ...
    run_step(["python3", os.path.join("scripts", "parse_midmonth_output.py"), month_id])
    ...
    print("\n[Ferdig] Midtveisoppdatering er lagt inn og aktive filer er oppdatert.")
